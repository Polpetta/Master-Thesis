...
interface, but it has a RESTful API that allow users to interact with it using
...
Harbor, in fact, during NS is deletion, it checks if any related VNF remains
...
\subsubsection{Docker Swarm} Introduced in ??\todo{Find Docker Swarm date of
