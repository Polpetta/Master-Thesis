...
Started as a Virtual VNFM (Network Function Virtualization Manager) to offer 
...
the possibility to manage Network Services and to update the route tables, 
Roulette Controller (the tool description can be found below
in~\ref{chap:prjan:sec:tech:sub:SFC:sub:roulette}). Harbor doesn't have a web 
interface, but it has a RESTful API that can allow users to interact with him 
