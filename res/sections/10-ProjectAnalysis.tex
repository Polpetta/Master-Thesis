...
written in Java born in 2011~\cite{floodlightGit}. It allows various
...
purpose of solving different user needs over the network. When instantiated,
OpenSwitch routers have to register to the controller in order to gain routing
