...
backbones having more and more data to deliver, making in-hardware solutions 
less efficent. Their time-to-deploy, in fact, is very high compared 
to the requirements of the network. With this trend, in-hardware solutions 
will not be able to keep up the Internet needs. Is with this considerations 
that software-based approach, based on virtualization technologies, is being 
proposed to become the new way to deploy network components. While less 
efficent, they are faster to bring them up, offering an unprecedented 
flexibility\todo{CITE: SDN/NFV-Based Mobile Packet Core Network Architectures: A 
Survey}.
 ...
 Docker Swarm), allow to easily manage the application lifecyle, i.e. its
...
and takes into account final considerations.
 \end{itemize}
