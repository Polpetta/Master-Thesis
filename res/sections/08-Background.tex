...
architecture can be splitted into three different layers, based on their
...
\emph{SDN controllers}, instead, are logically centralized components that
...
In the lowest part of the architecture we can find the \emph{SDN Networking Devices}. These ones control packet forwarding and data processing capabilities of the network. They comprises a CDPI agent and a set of one or more traffic forwarding engines and zero or more traffic processing functions (the logic of the devices).
...
network resources. \todo{To change I do not what can I write, stolen from ``The
research and implementation of cloud computing platform based on docker'' paper}

\subsection{Network Virtualization}
%https://s3.amazonaws.com/academia.edu.documents/29016225/cs-2008-25.pdf?AWSAccessKeyId=AKIAIWOWYYGZ2Y53UL3A&Expires=1541352965&Signature=On6XJ5daSAmnfJMnNf41fBNHFgg%3D&response-content-disposition=inline%3B%20filename%3DA_survey_of_network_virtualization.pdf
