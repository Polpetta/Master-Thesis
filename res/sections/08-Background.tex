...
functionalities. The \emph{SDN Applications} role is to set the 
behaviour of the SDN controllers and manage its hardware resources and data 
through APIs, often called \emph{northbound interfaces}(NBI).
