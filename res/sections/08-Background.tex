...
are part of a certain chain, in the matter case they are called \emph{SFC aware}
...
and \emph{Service Function Path} (SFP) components. The latter is the element of
...
\begin{figure}[t]
  ...
  \caption{5G Architecture~\cite{alliance20155g}}
