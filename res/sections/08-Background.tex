...
\subsection{Service Instance Layer}
...
\subsection{Network Slice Instance Layer}
...
decoupled from the hardware where its running.

\vspace{0.5cm}

Every NF should be isolated, so that it only has the possibility to consumed a
