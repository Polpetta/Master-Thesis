...
Kubernetes as a \verb!Service!. For a \verb!Service! a \verb!ReplicaSet! and a
consequent \verb!Deployment! can be associated, giving the possibility for it to
scale under heavy workloads. The introduction of scalability meant that was not
...
\subsubsection{Dyamic package routing: the Roulette component}
