...
\begin{figure}[t]
  ...
  \caption[IP Encapsulation within IP packet schema]{An schema of IP 
...
components (plug-ins) dynamically. Openbaton can be installed on-permise 
installations but it can also run on Docker containers. It's designed to work 
with cloud providers like Amazon or Google Compute engine, but it offers 
compability with on-permise cloud solutions like Openstack too.
\begin{figure}[h]
 \centering
