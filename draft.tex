...
payload\todo{Make an image showing a packet inside another packet, to make easy
  to understand what we're meaning here}, that can be elaborated and modified
