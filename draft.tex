...
the main requirement. Starting with this objective, we encountered that, many 
networking tools already present in the market, required some tweaking and some 
integrations, shifting our goal to create a complete  ETSI (European
Telecommunications Standards Institutes) MANO testbed, following the 
specifications suggested in the RFC 7665.
\end{document}
