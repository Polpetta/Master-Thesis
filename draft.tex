...
%   + Related works (how are we gonna do that??)
...
% - Project description (tell how we've done stuff)
...
\label{chap:intro}
 ...
 them up, offering an unprecedented flexibility\todo{CITE: SDN/NFV-Based Mobile
