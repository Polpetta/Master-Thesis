...
were not designed with enough flexibility to be able to accept new 
virtualization technologies such as Docker. In the next session we are going to 
take a deep analysis of the cited technologies, in order to provide to the 
reader enough context to be able to understand our design choices we are going 
to describe later.
